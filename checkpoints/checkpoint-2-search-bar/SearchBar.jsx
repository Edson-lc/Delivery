      ...
      <div className="relative">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-12 pr-12 py-4 text-lg border-2 border-gray-200 rounded-2xl focus:border-orange-500 focus:ring-0 transition-all duration-200 bg-white shadow-lg hover:shadow-xl"
          />
          {searchTerm && (
            <Button
              variant="ghost"
        ...
        <Button
          ...
          className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 hover:bg-orange-600 text-white rounded-xl px-6 py-2 shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50"
        >
          {isLoading ? (
