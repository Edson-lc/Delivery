  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-orange-50 to-red-50">
        <Sidebar collapsible="none" className="border-r border-orange-200 bg-white/80 backdrop-blur-sm transition-all duration-300 w-64">
                ...
                <SidebarMenu className="space-y-1">
                  {navigationItems.map((item) => (
                    <SidebarMenuItem key={item.title}>
                      ...
                      >
                        <Link to={item.url} aria-label={item.title} className="flex items-center gap-3 px-4 py-3">
